<?php
/* Smarty version 3.1.33, created on 2020-11-06 11:30:29
  from '/var/www/html/conndo.com.br/admin/templates/default/pages/administratrix/administratrix.phtml' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5fa55e05e7d9d7_84648709',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e0449d22452d65661daed788fcb42dc178b9a93b' => 
    array (
      0 => '/var/www/html/conndo.com.br/admin/templates/default/pages/administratrix/administratrix.phtml',
      1 => 1604642834,
      2 => 'file',
    ),
  ),
...
function content_5fa55e05e7d9d7_84648709 (Smarty_Internal_Template $_smarty_tpl) {
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="titleModalHead"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('l'=>'Add Administratrix'),$_smarty_tpl ) );?>
</h4>
            </div>
            <!-- FORM -->
                ...
                <div class="modal-body">                    
                    <div class="form-group">
                        <div class="col-md-10 col-xs-12"> 
                            ...
                            <input type="text" class="form-control" id="nome" name="nome" maxlength="100" required value="" />
                        </div>
                    </div>
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="col-md-6 col-xs-12"> 
                            <label class="control-label"><sup class="required">*</sup><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('l'=>'Type Person'),$_smarty_tpl ) );?>
</label>																						
                            <select class="form-control select" required id="tipo_pessoa" name="tipo_pessoa">													
                                ...
                                <option value="J"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('l'=>'Legal Entity'),$_smarty_tpl ) );?>
</option>
                                <option value="F"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('l'=>'Physical Person'),$_smarty_tpl ) );?>
</option>
                            </select>
                        </div>

                        <div tipo-pessoa="J" class="col-md-6 col-xs-12"> 
                        ...
                        <div tipo-pessoa="F" class="col-md-6 col-xs-12 none"> 
