<?php
/* Smarty version 3.1.33, created on 2021-01-11 13:52:06
  from '/var/www/html/conndo.com.br/admin/templates/default/pages/accountpay/accountpay_list.phtml' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5ffc8236e51ad2_51742794',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a0ebb158f6e74b7a1bf908c0e2baa4c403518fc6' => 
    array (
      0 => '/var/www/html/conndo.com.br/admin/templates/default/pages/accountpay/accountpay_list.phtml',
      1 => 1610380630,
      2 => 'file',
    ),
  ),
...
function content_5ffc8236e51ad2_51742794 (Smarty_Internal_Template $_smarty_tpl) {
ob_start();
...
<ul class="breadcrumb">
    ...
    <li class="active"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('l'=>'Account to Pay'),$_smarty_tpl ) );?>
</li> 
    </ul>
<!-- END BREADCRUMB -->                

<div class="page-title">                    
    <h2><span class="fal fa-calculator"></span> <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('l'=>'Account to Pay'),$_smarty_tpl ) );?>
</h2>
</div> 
...
/add')" class="btn btn-success" >
            ...
            <div class="panel-body">
                <div class="table-responsive list-datatable">
                    <p>
                    <table id="dataTable" class="table tableAccountPay">
                        <thead>
                            <tr>
                                <th style="max-width: 20px">
                                    <label class="check">
                                        <input type="checkbox" id="checkAll" class="icheckbox" name="all" onchange="Accountpay.checkAll()" />
                                    </label>
                                </th>
