<?php
/* Smarty version 3.1.33, created on 2021-04-21 13:17:38
  from '/var/www/html/conndo.com.br/admin/templates/default/pages/financialpayment/financialpayment_list.phtml' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_60805022bc9541_18842153',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f31d54bd6c344ad2c97854c900bd058d25952e44' => 
    array (
      0 => '/var/www/html/conndo.com.br/admin/templates/default/pages/financialpayment/financialpayment_list.phtml',
      1 => 1610380630,
      2 => 'file',
    ),
  ),
...
function content_60805022bc9541_18842153 (Smarty_Internal_Template $_smarty_tpl) {
ob_start();
...
<ul class="breadcrumb">
    ...
    <li class="active"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('l'=>'Payment'),$_smarty_tpl ) );?>
</li>
</ul>
<!-- END BREADCRUMB -->                
<div class="page-title">
    <h2><span class="fal fa-cash-register"></span> <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('l'=>'Payment'),$_smarty_tpl ) );?>
</h2>
...
<div class="page-content-wrap" id="boxMovement" style="min-height:650px;">
    <div class="row">
        <div class="col-md-12"> 
            <div class="page-content-wrap___" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-12">  
                                            ...
                                            <select class="form-control selectpicker" id="status" name="status" >
                                                ...
                                                <option value="CTD"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('l'=>'Paid Out'),$_smarty_tpl ) );?>
</option>
 ...
 <span class="caret"></span></a>
                        ...
                        <div class="panel-body">
                            <div class="row">                          
                                ...
                                <table id="dataTable" class="table tableFinancialPayment">
                                    <thead>
                                        <tr> 
                                            <th style="max-width: 20px">
                                                <label class="check">
                                                    <input type="checkbox" id="checkAll" class="icheckbox" disabled name="all" onchange="Financialpayment.checkAll()" />
                                                </label>
                                            </th>
...
"   onClick="Financialpayment.approveMovement('<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
')" id="approveMovement">
...
"  onClick="Financialpayment.rejectMovement('<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
')" id="rejectMovement">
                            ...
                            <button type="button" class="btn btn-default btn-action" disabled 
                                    title="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('l'=>'Pay'),$_smarty_tpl ) );?>
"  onClick="Financialpayment.receivePayment('<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
')" id="receivePayment">
                                <i class="fal fa-hand-holding-usd fa-lg green disabled"></i>
                                <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('l'=>'Pay'),$_smarty_tpl ) );?>
